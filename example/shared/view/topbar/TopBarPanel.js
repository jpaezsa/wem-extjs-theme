Ext.define('Admin.view.topbar.TopBarPanel', {
    extend: 'Ext.toolbar.Toolbar',
    alias: 'widget.topBarPanel',

    requires: [
        'Admin.view.topbar.TopBarMenu',
        'Admin.view.topbar.StartMenu'
    ],
    ...
    initComponent: function () {
        var topBarMenu = Ext.create('Admin.view.topbar.TopBarMenu', {
            listeners: {
        ...
        var startMenu = Ext.create('Admin.view.topbar.StartMenu', {
            xtype: 'startMenu',
